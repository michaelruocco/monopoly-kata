...
public class AdvanceToMaryleboneStationTest {

    private static final String LOCATION_NAME = "Marylebone Station";

    private final Board board = new Board();
    private final ChanceCard chanceCard = new AdvanceToMaryleboneStation();
    ...
    public void shouldReturnText() {
        assertThat(chanceCard.getText()).isEqualTo("Take a trip to " + LOCATION_NAME + ". If you pass GO, collect £200");
    }
